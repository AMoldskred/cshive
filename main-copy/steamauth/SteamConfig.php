<?php
//Version 3.2
$steamauth['apikey'] = "xxxxxxxxxxxxxxxxxxxxxxxxx"; // Your Steam WebAPI-Key found at http://steamcommunity.com/dev/apikey
$steamauth['domainname'] = "domain.com"; // The main URL of your website displayed in the login page
